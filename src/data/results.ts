...
export const models: Model[] = [
  ...
  // 21 dropped for missing turn scores), judged by Claude Sonnet 4.6. Replaced
  // Gemini Flash Lite (the paper's Google entry) on the main board July 2026.
  {
    rank: 4,
...
export const rankingComparison = [
  ...
  { model: "DeepSeek V4", awmsRank: 5, awvsRank: 3, shift: 2 },
